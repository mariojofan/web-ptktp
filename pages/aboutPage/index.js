        ...
        <div className='container mx-auto md:px-12 mt-86 px-3'>
          <div className='flex flex-wrap flex-col lg:flex-row'>
              <div className='w-full text-center z-30 lg:w-6/12 flex flex-col my-auto md:mx-auto md:text-center lg:text-left'>
                <h1 className='font-bold text-2xl md:text-5xl'>Build
                <span className='text-primary-500 font-extrabold uppercase'> Faster </span>Build 
                <span className='text-primary-500 font-extrabold uppercase'> Better </span> </h1>

                <p className='w-full lg:w-3/4 text-gray-500 text-sm md:text-base my-5'>Sederhanakan proses Anda dan tingkatkan kolaborasi karyawan. Uraikan proyek Anda dalam tugas-tugas kecil dan tetapkan ke tim Anda untuk meningkatkan kolaborasi.</p>
              ...
              <div className='w-8/12 lg:w-6/12 text-center z-10 mx-auto'>
                <Image src='/images/Illustrations/illustration3d.svg' width={600} height={550} />
              </div>
        ...
        <div className='container mx-auto px-3 py-5 lg:px-12 lg:py-24'>
          <div className='flex flex-col lg:flex-row w-12/12'>
            <div className='flex flex-col items-center text-center ml-px lg:ml-40 lg:text-left lg:flex-row'>
              ...
              <p className='ml-5 mt-3 lg:mt-px lg:w-6/12'>Kami mengidentifikasi dan memelihara tim desainer, pengembang, dan pemasar yang benar-benar beragam</p>
            </div>
      ...
      <section className='font-display mb-52'>
        <div className='container px-3 mx-auto flex flex-wrap flex-col lg:flex-row items-center mt-20'>
          ...
          <div className='flex flex-col justify-items-center w-5/6 lg:w-3/6'>
            ...
            <H1 className='my-4' variant='text1'>PT. Klabat Tekno Perkasa memberikan solusi bagi Transformasi Digital Perusahaan Anda</H1>
            <p className='text-fourth-700'>Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmodincididuntut labore et dolore magna aliqua.</p>
      ...
      <section className='font-display bg-bgMeteor'>
        <div className='container mx-auto px-12 w-full'>
          <div className='text-center mx-auto w-full lg:w-2/6'>
            <Image src='/images/Illustrations/illustration4.svg' width={350} height={350} />
            <p className='text-md'>Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Nec dui nunc mattis enim ut tellus elementum. Ligula ullamcorper malesuada proin libero nunc consequat interdum varius sit. Ultricies integer quis auctor elit sed.</p>
          </div>
      
          <div className='text-center mx-auto w-full lg:w-2/6 mt-10 mb-40'>
            <Image src='/images/Illustrations/illustration5.svg' width={350} height={350} />
            <p className='text-md'>Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Nec dui nunc mattis enim ut tellus elementum. Ligula ullamcorper malesuada proin libero nunc consequat interdum varius sit. Ultricies integer quis auctor elit sed.</p>
          </div>
        </div>
      </section>
